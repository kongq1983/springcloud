package com.kq.springcloud.printable;
 ...
 * @date 2018-11-01
 */
public class SaleTicket implements Printable {

    private SaleOrder saleOrder;


    public SaleTicket(SaleOrder saleOrder){
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        //设置操作员
        g2.drawString("操作员:"+saleOrder.getName(),(float)x+20,(float)y+line);
        line+=heigth;
...
//设置商品清单
        ...
        if(saleOrder.getDetails()!=null && saleOrder.getDetails().size()>0){

            for(SaleOrderDetail gdf:saleOrder.getDetails()){
                ...
                g2.drawString(String.valueOf(gdf.getTotal()),(float)x+120,(float)y+line);
                line += heigth;
            }
